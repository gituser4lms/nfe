...
class core_course_renderer extends plugin_renderer_base {
    ...
    public function course_section_cm_name_title(cm_info $mod, $displayoptions = array()) {
        ...
        $instancename = "<div>".$mod->get_formatted_name()."</div>";
        ...
        // Display link itself.
        $activitylink = "<div class='row w-100 d-flex justify-content-center'><div class='col-md-4 col-sm-icon col-xs-12 justify-content'>". html_writer::empty_tag('img', array('src' => $mod->get_icon_url(),
                'class' => 'iconlarge activityicon', 'alt' => '', 'role' => 'presentation', 'aria-hidden' => 'true')) . "</div>" .
                html_writer::tag('span', $instancename . $altname, array('class' => 'instancename d-flex align-items-center col-md-8 col-sm-icon-des col-xs-12')) . "</div>";
        if ($mod->uservisible) {
    ...
    public function course_section_cm($course, &$completioninfo, cm_info $mod, $sectionreturn, $displayoptions = array()) {
        ...
        if (!empty($cmname)) {
            ...
            $output .= html_writer::start_tag('div', array('class' => 'activityinstance w-100'));
            $output .= $cmname;
    ...
    protected function coursecat_category(coursecat_helper $chelper, $coursecat, $depth) {
        ...
        $content = html_writer::start_tag('div id="cat" class="col-md-4" style="display:flex;align-items:flex-start;justify-content:center;"', array(
            'class' => join(' ', $classes),
