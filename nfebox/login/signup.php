...
label[for="id_profile_field_last_attended_year"]::before {
	font-family: FontAwesome;
	font-weight: 900;
	content: "\f02d";
	top: 10px;	
...
label[for="id_profile_field_school"]::before {
	font-family: FontAwesome;
	font-weight: 900;
	content: "\f015";
	top: 1px;
}
label[for="id_profile_field_township"]::before {
	font-family: FontAwesome;
 	font-weight: 900;
	content: "\f041";
	top: 1px;
}
label[for="id_profile_field_hometownship"]::before {
	font-family: FontAwesome;
	font-weight: 900;
	content: "\f041";
	top: 1px;
...
#id_profile_field_last_attended_year {
	border: 1px solid rgba(51, 102, 0, 0.5);
