...
if (!$csv) {
    ...
    print '</th>';
/************************/
    print '<th scope="col" class="completion-sortchoice" style="font-size:17px;font-weight:600;color:green;">အမေအမည်</th><th scope="col" class="completion-sortchoice" style="font-size:17px;font-weight:600;color:green;">ကျောင်းအမည်</th><th scope="col" class="completion-sortchoice" style="font-size:17px;font-weight:600;color:green;">နောက်ဆုံးကျောင်းတက်ခဲ့သည့်နှစ်</th><th scope="col" class="completion-sortchoice" style="font-size:17px;font-weight:600;color:green;">လက်ရှိနေထိုင်သည့်မြို့နယ်</th><th scope="col" class="completion-sortchoice" style="font-size:17px;font-weight:600;color:green;">မွေးရပ်မြို့နယ်</th>';
/************************/
...
if ($csv) {
	print csv_quote('အမည်').$sep.csv_quote('အမေအမည်').$sep.csv_quote('ကျောင်းအမည်').$sep.csv_quote('နောက်ဆုံးကျောင်းတက်ခဲ့သည့်နှစ်').$sep.csv_quote('လက်ရှိနေထိုင်သည့်မြို့နယ်').$sep.csv_quote('မွေးရပ်မြို့နယ်');
}
foreach($activities as $activity) {
    ...
    if ($csv) {
        ...
        print '<th scope="col" class="completion-header '.$datepassedclass.'">'.
            ...
            '<div class="rotated-text-container"><span class="rotated-text" style="position:relative;left:-10px;font-size:16px;font-weight:600;color:green;">'.$shortenedname.'</span></div>'.
            '<div class="modicon">'.
...
foreach($progress as $user) {
    ...
    $type_school_name = $DB->get_field_sql("SELECT f.id 
              FROM {user_info_field} AS f
