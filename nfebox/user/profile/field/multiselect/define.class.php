...
class profile_define_multiselect extends profile_define_base
{
	...
	$currentyear = date('Y');
        ...
        $options = array_combine(range($currentyear,$startyear), range($currentyear,$startyear));
        /// Param 1 for menu type contains the options
        $form->addElement('select', 'param1', get_string('profilemenuoptions', 'admin'), $options);

        //$mform->addElement('select', 'param1', get_string('profilemenuoptions', 'admin'), array('rows' => 6, 'cols' => 40));
